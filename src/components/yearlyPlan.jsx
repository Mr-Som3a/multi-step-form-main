    ...
    return ( 
        <>
            <div className='sub_cards yearly'>
                <button onClick={()=>HandlePlan('Acrade',90)} className='card'>
                    <img src="/assets/images/icon-arcade.svg" alt="" />
                    <div>Arcade<p>$90/yr</p>2 months free</div>
                </button>
                <button  onClick={()=>HandlePlan('Advanced',120)} className='card'>
                    <img src="/assets/images/icon-advanced.svg" alt="" />
                    <div>Advanced<p>$120/yr</p>2 months free</div>
                </button>
                <button  onClick={()=>HandlePlan('Pro',150)} className='card'>
